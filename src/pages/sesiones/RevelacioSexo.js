...
export default function RevelacioSexo() {
    ...
    const dataPrecios = [
        {
            titulo_opcion: ['REVELACIÓN DEL SEXO 90 €'],
            descripcion: [
    ...
    const dataCollapse = [
        ...
        {'¿Quién puede participar en la sesión?': 'En el primer pack (Revelación del sexo) la unión familiar, mamas, papas y hermanitos si hay. En el pack (Revelación familiar) puede participar la unión familiar y todo aquel familiar que quiera ser partícipe de esta experiencia. Máximo de 20 personas.'},
